    ...
    while (scanning)
        switch (((previous = character2), (character2 = next()))) {
            ...
            default:
                ...
                switch (
                    ((characters2 += from(character2)), character2 * variable)
                ) {
                    case 38:
                        ampersand =
                            offset > 0 ? 1 : ((characters2 += '\f'), -1);
                        break;
                    case 44:
                        (points[index++] =
                            (strlen(characters2) - 1) * ampersand),
                            (ampersand = 1);
                        break;
                    case 64:
    ...
    switch (hash(value, length2)) {
        ...
        case 4200:
            if (!match(value, /flex-|baseline/))
                return (
                    MS + 'grid-column-align' + substr(value, length2) + value
                );
            break;
        case 2592:
        case 3360:
        ...
        case 3616:
            if (
                ...
                children.some(function (element, index) {
                    return (
                        (length2 = index), match(element.props, /grid-\w+-end/)
                    );
                })
            ) {
                return ~indexof(
                    value + (children = children[length2].value),
                    'span',
                    0,
                )
                    ? value
    ...
    return (
        ...
        (e.prototype.insertRules = function (e2, t) {
            if (e2 >= this.groupSizes.length) {
                for (
                    var n = this.groupSizes, o2 = n.length, r2 = o2;
                    e2 >= r2;
        ...
        return (function (e3, r4, s3) {
            ...
            var v2 = I(r4, f3, c3) || C,
                g3 = (function (e4, n, o2) {
                    ...
                    return (
                        n.className &&
                            (s4.className = ie(s4.className, n.className)),
                        s4
                    );
                })(i3, r4, v2),
                S3 = g3.as || h2,
