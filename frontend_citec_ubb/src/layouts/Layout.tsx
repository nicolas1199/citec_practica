  ...
  return (
    <>
      <div className="flex">
        ...
        <aside
          id="logo-sidebar"
          className={`fixed top-0 left-0 z-40 w-52 h-screen pt-20 transition-transform transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'
              ...
              <li>
                <div>
                  ...
                  >
                    ...
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className={`w-5 h-5 transition-transform ${isUsuariosMenuOpen
                          ? 'rotate-180'
                          : ''
                        }`}
                      fill="none"
              ...
              <li>
                <div>
                  ...
                  >
                    ...
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className={`w-5 h-5 transition-transform ${isEmpresasMenuOpen
                          ? 'rotate-180'
                          : ''
                        }`}
                      fill="none"
              ...
              <li>
                <div>
                  ...
                  >
                    ...
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className={`w-5 h-5 transition-transform ${isServiciosMenuOpen
                          ? 'rotate-180'
                          : ''
                        }`}
                      fill="none"
              ...
              <li>
                ...
                <button
                  ...
                  >
                    ...
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className={`w-5 h-5 transition-transform ${isEnsayosMenuOpen
                          ? 'rotate-180'
                          : ''
                        }`}
                      fill="none"
              ...
              <li>
                <div>
                  ...
                  >
                    ...
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className={`w-5 h-5 transition-transform ${isOrdenTrabajoMenuOpen
                          ? 'rotate-180'
                          : ''
                        }`}
                      fill="none"
