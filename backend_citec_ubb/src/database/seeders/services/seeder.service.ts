...
import { InfoGralDocumentosSeeder } from '../seed/info-gral-documentos.seeders';
...
export class SeederService {
    constructor(
        ...
        private readonly infodocumentosSeeder: InfoGralDocumentosSeeder,
    ) { }
    ...
    async run() {
        ...
        await this.infodocumentosSeeder.run();
    }
}
