...
import { ObtenerPorIdValidezDto, ValidezDeDocumentoDto } from '../dto/create-validez-de-documento.dto';
...
export class ValidezDeDocumentoService extends BaseServicesSimple {
  ...
  async obtenerPorId(clavePrimaria: ObtenerPorIdValidezDto): Promise<ValidezDocumentos> {
    const retornoEstado = await ValidezDocumentos.findByPk(clavePrimaria.nombre);
