...
export class CrearDocumentoDto {
    ...
    @Length(1, 50, {
        message:
            'La longitud del nombre del proyecto debe ser entre 1 y 50 caracteres',
    })
    ...
    @Length(1, 50, {
        message:
            'La longitud del nombre del cliente debe ser entre 1 y 50 caracteres',
    })
...
export class UpdateDocumentoDto extends PickType(obtenerDocumentoPorIdDto, [
    'numero',
]) {}
export class EliminarDocumentoDto extends PickType(obtenerDocumentoPorIdDto, [
    'numero',
]) {}
